<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"C:\wamp\www\blog\public/../application/index\view\user\register.html";i:1537281898;}*/ ?>
<!DOCTYPE html>
<html lang="zh">
<head>
	<meta charset="UTF-8" />
	...
	<link rel="stylesheet" href="http://www.tp5.com/blog/public/static/index/css/bootstrap.min.css" />
	<link rel="stylesheet" href="http://www.tp5.com/blog/public/static/index/css/animate.css" />
	<link rel="stylesheet" href="http://www.tp5.com/blog/public/static/index/css/index.css" />
</head>
<body>
		...
		<div class="content center-block animated fadeInDown">
			...
			<form action="" method="post">
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="conpass" name="re_password" placeholder="确认密码" />
				</div>
				<div class="form-group">
